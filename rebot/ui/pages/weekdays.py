...
weekdays_page = Page(
    ...
    Row(
        Button(
            Const(text.get(text.ButtonKeys.MONDAY)),
            id="monday_button",
            on_click=on_monday_button_click
        ),

        Button(
            Const(text.get(text.ButtonKeys.TUESDAY)),
            id="tuesday_button",
            on_click=on_tuesday_button_click
        ),

        Button(
            Const(text.get(text.ButtonKeys.WEDNESDAY)),
            id="wednesday_button",
            on_click=on_wednesday_button_click
        ),
    ),

    Row(
        Button(
            Const(text.get(text.ButtonKeys.THURSDAY)),
            id="thursday_button",
            on_click=on_thursday_button_click
        ),

        Button(
            Const(text.get(text.ButtonKeys.FRIDAY)),
            id="friday_button",
            on_click=on_friday_button_click

        ),
        Button(
            Const(text.get(text.ButtonKeys.SATURDAY)),
            id="saturday_button",
            on_click=on_saturday_button_click
        ),
    ),
