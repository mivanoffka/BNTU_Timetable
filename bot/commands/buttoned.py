    ...
    if msg.from_user.id in data.waiting_for_group_num:
        ...
        if msg.text == keyboards.today_button.text:
            ...
            txt = "<u>Ответы на вопросы, которые могли у вас возникнуть.</u>"\
                  ...
                  " У старших же курсов оно разбросано по десятку таблиц, форматирование которых кардинально отличается" \
                  " друг от друга и не может быть обработано одинаковой программой. "\
                    "\n\nВ скором времени я планирую добавить сюда поддержку расписаний 3-го и 4-го курса, <u>но только" \
                  " для ФИТР.</u> Для остальных факультетов, скорее всего, сделать это не получится... 😔</i>"\
